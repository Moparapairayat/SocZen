    ...
    <main className="min-h-screen overflow-x-hidden pb-12">
      ...
      >
        ...
        <div className="relative z-10 inline-flex max-w-[92vw] items-center gap-1.5 sm:gap-2 rounded-full border-2 border-foreground bg-card px-3 sm:px-4 py-1 sm:py-1.5 text-[11px] sm:text-xs font-black shadow-brutal-sm">
          ...
          <Gift className="h-3.5 w-3.5 text-brand-pink shrink-0" />
          <span className="truncate">100% Free Access</span>
          <span className="h-1 w-1 rounded-full bg-foreground/40 shrink-0" />
          <span className="text-brand-violet dark:text-brand-cyan shrink-0">No Credit Card</span>
        </div>
